 ...
 * @author Admin
 */
public class facil4 extends javax.swing.JFrame {

    /**
     * Creates new form facil4
     */
    public facil4() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Nível Facil - Questão 4");
        getContentPane().setLayout(null);

        rdbd.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        rdbd.setText(" Diversidade da natureza viva ");
        ...
        rdbd.setBounds(51, 272, 209, 25);

        rdbb.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        rdbb.setText(" Diversidade da natureza morta ");
        ...
        rdbb.setBounds(51, 186, 221, 25);

        rdbc.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        rdbc.setText(" Estudo a diversidade da biologia ");
        ...
        rdbc.setBounds(51, 229, 227, 25);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("O que é biodiversidade?");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(51, 46, 164, 17);

        rdba.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        rdba.setText("Diversidadede de Pessoas");
        ...
        btncontinuar.setBounds(617, 550, 90, 23);

        lblimg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/1.png"))); // NOI18N
        getContentPane().add(lblimg);
        lblimg.setBounds(520, 170, 356, 320);
        ...
        btnanular.setBounds(60, 550, 61, 23);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(facil4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
