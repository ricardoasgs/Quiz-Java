 ...
 * @author Admin
 */
public class medio4 extends javax.swing.JFrame {

    /**
     * Creates new form medio4
     */
    public medio4() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Nível Medio - Questão 4");
        getContentPane().setLayout(null);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("Como é chamada a parte liquida do lixo, muito perigosa para o meio ambiente ?");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(70, 41, 545, 17);

        rdba.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        rdba.setText("chorume.");
        ...
        btncontinuar.setBounds(629, 540, 90, 23);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(medio4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
